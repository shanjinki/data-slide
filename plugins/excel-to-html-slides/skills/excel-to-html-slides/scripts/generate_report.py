...
STYLE_THEMES = {
    ...
    "ink-wash": {
        "name": "Ink Wash",
        "body_class": "theme-ink",
        "stage": "light",
        "accent": "#b91c1c",
    },
    "terminal-green": {
        "name": "Terminal Green",
        "body_class": "theme-terminal",
        "stage": "dark",
        "accent": "#65a30d",
    },
    "neon-noir": {
    ...
    "swiss-grid": {
        "name": "Swiss Grid",
        "body_class": "theme-swiss",
        "stage": "light",
        "accent": "#dc2626",
    },
    "blueprint": {
        "name": "Blueprint",
        "body_class": "theme-blueprint",
        "stage": "dark",
        "accent": "#93c5fd",
    },
    "copper-report": {
        "name": "Copper Report",
        "body_class": "theme-copper",
        "stage": "light",
        "accent": "#b45309",
    },
    "editorial-red": {
    ...
    "glass-board": {
        "name": "Glass Board",
        "body_class": "theme-glass",
        "stage": "dark",
        "accent": "#2dd4bf",
    },
    "midnight-gold": {
        "name": "Midnight Gold",
        "body_class": "theme-gold",
        "stage": "dark",
        "accent": "#d6a84f",
    },
    "paper-ledger": {
        "name": "Paper Ledger",
        "body_class": "theme-paper",
        "stage": "light",
        "accent": "#166534",
    },
    "cobalt-grid": {
        "name": "Cobalt Grid",
        "body_class": "theme-cobalt",
        "stage": "dark",
        "accent": "#facc15",
    },
    "highlighter": {
        "name": "Highlighter",
        "body_class": "theme-highlighter",
        "stage": "light",
        "accent": "#111827",
    },
}
...
def base_css() -> str:
    return r"""
*{box-sizing:border-box}html,body{margin:0;min-height:100%;font-family:"PingFang SC","Microsoft YaHei",Arial,sans-serif}body{overflow-x:hidden}.page-shell{position:relative;z-index:1;width:min(1180px,calc(100% - 32px));margin:0 auto;padding:44px 0 64px}#bgCanvas{position:fixed;inset:0;width:100%;height:100%;z-index:0;pointer-events:none}.theme-command{background:#08111f;color:#e5eefc}.theme-light{background:#f4f7fb;color:#142033}.theme-retail{background:#fff7ed;color:#1f2937}.theme-ledger{background:#101815;color:#e7f5ee}.theme-editorial{background:#fbf4e9;color:#241b15}.theme-studio{background:#101020;color:#eeeaff}.theme-ink{background:#f7f2e8;color:#201b16}.theme-terminal{background:#050805;color:#d8ffd2;font-family:"SFMono-Regular","Menlo","Consolas",monospace}.theme-neon{background:#08070a;color:#f5f3ff}.theme-swiss{background:#fafafa;color:#111827}.theme-blueprint{background:#08213e;color:#e8f2ff}.theme-copper{background:#f5f0e8;color:#24160f}.theme-red{background:#fff7f2;color:#231f20}.theme-glass{background:#101820;color:#eef9f6}.theme-gold{background:#0b0a08;color:#f5ecd7}.theme-paper{background:#f4f8ef;color:#1f2a21}.theme-cobalt{background:#07172f;color:#eef5ff}.theme-highlighter{background:#fbfbf2;color:#111827}
.hero{display:grid;grid-template-columns:minmax(0,1fr) 280px;gap:24px;align-items:end;padding:32px 0 28px}.eyebrow{letter-spacing:.18em;text-transform:uppercase;font-size:12px;color:var(--muted);margin:0 0 12px}.hero h1{font-size:clamp(34px,5vw,64px);line-height:1.05;margin:0 0 14px;letter-spacing:0}.subtitle{font-size:18px;line-height:1.7;color:var(--muted);margin:0;max-width:760px}.meta-panel{border:1px solid var(--border);background:var(--card);border-radius:18px;padding:18px 18px;display:grid;grid-template-columns:84px 1fr;gap:8px 10px;box-shadow:var(--shadow)}.meta-panel span{color:var(--muted);font-size:12px}.meta-panel strong{font-size:13px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.section{margin:22px 0}.section-title,.card-title{display:flex;align-items:center;gap:10px;margin-bottom:14px}.section-title span,.card-title span{display:inline-flex;align-items:center;justify-content:center;min-width:34px;height:26px;border-radius:999px;background:var(--accent-soft);color:var(--accent);font-size:12px;font-weight:800}.section-title h2,.card-title h2{font-size:20px;margin:0}.two-col{display:grid;grid-template-columns:1.2fr .8fr;gap:18px}.card,.kpi,.cat-card,.risk-card,.metric-card{background:var(--card);border:1px solid var(--border);border-radius:18px;box-shadow:var(--shadow);backdrop-filter:blur(14px)}.card{padding:22px}.kpi-grid{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:14px}.kpi{position:relative;overflow:hidden;padding:18px 16px;min-height:132px}.kpi:before{content:"";position:absolute;inset:0 0 auto;height:3px;background:var(--tone,#38bdf8)}.kpi-label{font-size:13px;color:var(--muted);margin-bottom:10px}.kpi-value{font-size:36px;font-weight:850;line-height:1;margin-bottom:10px}.kpi-sub{font-size:12px;line-height:1.5;color:var(--muted)}.insight-list{display:grid;gap:12px}.insight{padding:14px 14px;border-radius:14px;background:var(--panel);border:1px solid var(--border);line-height:1.65}.insight strong{color:var(--accent)}.assumption-list{display:grid;gap:9px}.assumption{padding:10px 12px;border-radius:12px;background:var(--panel);color:var(--muted);font-size:13px}.funnel-layout{display:grid;grid-template-columns:380px minmax(0,1fr);gap:18px}.funnel{display:flex;flex-direction:column;align-items:center;padding:18px}.funnel-row{height:42px;margin-top:-5px;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:800;font-size:12px;text-shadow:0 1px 2px rgba(0,0,0,.28);clip-path:polygon(8% 0,92% 0,100% 100%,0 100%);min-width:130px}.funnel-row:first-child{margin-top:0}.bar-list{display:grid;gap:10px}.bar-item{display:grid;grid-template-columns:118px 1fr 76px minmax(120px,.7fr);gap:10px;align-items:center;font-size:13px}.bar-item small{color:var(--muted);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.bar-track{height:10px;background:var(--panel);border-radius:999px;overflow:hidden}.bar-fill{height:100%;border-radius:999px;background:var(--accent)}.cat-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px}.cat-card{padding:18px;position:relative;overflow:hidden}.cat-card:before{content:"";position:absolute;inset:0 0 auto;height:3px;background:var(--health)}.cat-head{display:flex;justify-content:space-between;gap:10px;margin-bottom:14px}.cat-name{font-size:20px;font-weight:850}.badge{font-size:12px;border-radius:999px;padding:5px 9px;background:var(--panel);color:var(--muted);white-space:nowrap}.cat-rate{font-size:34px;font-weight:900;color:var(--health);margin-bottom:8px}.mini-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin-top:12px}.mini{padding:9px;border-radius:12px;background:var(--panel);text-align:center}.mini b{display:block;font-size:18px}.mini span{font-size:11px;color:var(--muted)}.owner-line{margin-top:12px;font-size:12px;color:var(--muted);line-height:1.5}.special-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.special{padding:14px;border-radius:14px;background:var(--panel);border:1px solid var(--border)}.special h3{margin:0 0 8px;font-size:15px}.special-meta{display:flex;flex-wrap:wrap;gap:8px;color:var(--muted);font-size:12px}.sample-list{margin:10px 0 0;padding:0;list-style:none;display:grid;gap:7px}.sample-list li{font-size:12px;color:var(--muted);line-height:1.45}.risk-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}.risk-card{padding:18px;border-left:4px solid var(--risk)}.risk-card h3{margin:0 0 8px;font-size:17px}.risk-card p{margin:0 0 10px;color:var(--muted);line-height:1.6}.risk-card .action{padding:10px 12px;border-radius:12px;background:var(--panel);font-size:13px;line-height:1.55}.metric-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}.metric-card{padding:18px}.metric-card h3{margin:0 0 12px}.top-values{display:grid;gap:9px}.top-row{display:grid;grid-template-columns:minmax(0,1fr) 60px;gap:10px;align-items:center;font-size:13px}.data-table{width:100%;border-collapse:separate;border-spacing:0 8px}.data-table th{color:var(--muted);font-size:12px;text-align:left;font-weight:700;padding:0 10px 4px}.data-table td{background:var(--panel);border-top:1px solid var(--border);border-bottom:1px solid var(--border);padding:11px 10px;font-size:13px;line-height:1.45}.data-table td:first-child{border-left:1px solid var(--border);border-radius:12px 0 0 12px}.data-table td:last-child{border-right:1px solid var(--border);border-radius:0 12px 12px 0}.theme-command{--card:rgba(10,19,43,.82);--panel:rgba(15,28,58,.76);--border:rgba(56,189,248,.18);--muted:#93a4bb;--accent:#38bdf8;--accent-soft:rgba(56,189,248,.13);--shadow:0 18px 50px rgba(0,0,0,.28);--spark:rgba(56,189,248,.18)}.theme-light{--card:rgba(255,255,255,.92);--panel:#eef3f8;--border:#dbe4ef;--muted:#64748b;--accent:#1d4ed8;--accent-soft:#dbeafe;--shadow:0 18px 45px rgba(15,23,42,.08);--spark:rgba(29,78,216,.12)}.theme-retail{--card:rgba(255,255,255,.9);--panel:#fff1e7;--border:#fed7aa;--muted:#7c5b45;--accent:#f97316;--accent-soft:#ffedd5;--shadow:0 18px 45px rgba(154,52,18,.1);--spark:rgba(249,115,22,.14)}.theme-ledger{--card:rgba(15,31,27,.88);--panel:rgba(30,54,48,.72);--border:rgba(52,211,153,.18);--muted:#9cb5aa;--accent:#34d399;--accent-soft:rgba(52,211,153,.14);--shadow:0 18px 50px rgba(0,0,0,.24);--spark:rgba(52,211,153,.16)}.theme-editorial{--card:rgba(255,252,245,.94);--panel:#f4eadb;--border:#e8d8c3;--muted:#7b6653;--accent:#9f6b44;--accent-soft:#ead9c3;--shadow:0 18px 45px rgba(89,58,31,.09);--spark:rgba(159,107,68,.12)}.theme-studio{--card:rgba(18,18,32,.86);--panel:rgba(38,34,58,.72);--border:rgba(139,92,246,.2);--muted:#a6a0bd;--accent:#8b5cf6;--accent-soft:rgba(139,92,246,.16);--shadow:0 18px 50px rgba(0,0,0,.26);--spark:rgba(139,92,246,.16)}.theme-ink{--card:rgba(255,250,240,.9);--panel:#eee3d2;--border:#d6c6aa;--muted:#6b5b48;--accent:#b91c1c;--accent-soft:#f3d4c8;--shadow:0 20px 45px rgba(63,42,25,.12);--spark:rgba(185,28,28,.12);--texture:repeating-linear-gradient(90deg,rgba(32,27,22,.04) 0 1px,transparent 1px 19px);--texture-size:auto;--texture-opacity:.6}.theme-terminal{--card:rgba(2,18,7,.9);--panel:rgba(8,38,15,.78);--border:rgba(132,204,22,.26);--muted:#9bd58d;--accent:#84cc16;--accent-soft:rgba(132,204,22,.16);--shadow:0 18px 45px rgba(0,0,0,.35);--spark:rgba(132,204,22,.22);--texture:repeating-linear-gradient(0deg,rgba(132,204,22,.05) 0 1px,transparent 1px 7px);--texture-size:auto;--texture-opacity:.5}.theme-neon{--card:rgba(15,12,20,.9);--panel:rgba(28,21,36,.82);--border:rgba(34,211,238,.28);--muted:#b9aeca;--accent:#06b6d4;--accent-soft:rgba(236,72,153,.18);--shadow:0 18px 55px rgba(0,0,0,.38);--spark:rgba(236,72,153,.16);--texture:linear-gradient(135deg,rgba(6,182,212,.13) 0 1px,transparent 1px 24px),linear-gradient(45deg,rgba(236,72,153,.1) 0 1px,transparent 1px 28px);--texture-size:48px 48px;--texture-opacity:.5}.theme-swiss{--card:#fff;--panel:#f1f5f9;--border:#111827;--muted:#475569;--accent:#dc2626;--accent-soft:#fee2e2;--shadow:0 0 0 rgba(0,0,0,0);--spark:rgba(37,99,235,.12);--texture:linear-gradient(90deg,rgba(220,38,38,.11) 1px,transparent 1px),linear-gradient(rgba(37,99,235,.09) 1px,transparent 1px);--texture-size:64px 64px;--texture-opacity:.36}.theme-blueprint{--card:rgba(7,38,70,.9);--panel:rgba(13,59,102,.76);--border:rgba(147,197,253,.28);--muted:#bad8fb;--accent:#93c5fd;--accent-soft:rgba(147,197,253,.16);--shadow:0 18px 50px rgba(0,0,0,.28);--spark:rgba(147,197,253,.2);--texture:linear-gradient(90deg,rgba(147,197,253,.14) 1px,transparent 1px),linear-gradient(rgba(147,197,253,.14) 1px,transparent 1px);--texture-size:28px 28px;--texture-opacity:.55}.theme-copper{--card:rgba(255,252,246,.94);--panel:#ede1d2;--border:#c4a484;--muted:#6f5846;--accent:#b45309;--accent-soft:#fed7aa;--shadow:0 18px 45px rgba(120,53,15,.12);--spark:rgba(180,83,9,.15);--texture:repeating-linear-gradient(135deg,rgba(36,22,15,.05) 0 1px,transparent 1px 18px);--texture-size:auto;--texture-opacity:.45}.theme-red{--card:#fffdf8;--panel:#f4e8e2;--border:#111827;--muted:#5f4b4b;--accent:#be123c;--accent-soft:#ffe4e6;--shadow:0 16px 36px rgba(63,31,31,.1);--spark:rgba(190,18,60,.13);--texture:linear-gradient(90deg,rgba(190,18,60,.12) 0 4px,transparent 4px);--texture-size:110px 100%;--texture-opacity:.22}.theme-glass{--card:rgba(235,255,252,.12);--panel:rgba(224,252,247,.1);--border:rgba(125,211,252,.28);--muted:#bfdad8;--accent:#2dd4bf;--accent-soft:rgba(45,212,191,.16);--shadow:0 22px 60px rgba(0,0,0,.34);--spark:rgba(45,212,191,.18);--texture:linear-gradient(120deg,rgba(255,255,255,.08),transparent 32%,rgba(45,212,191,.07));--texture-size:100% 100%;--texture-opacity:.38}.theme-gold{--card:rgba(28,24,18,.92);--panel:rgba(48,39,28,.82);--border:rgba(214,168,79,.3);--muted:#c9b894;--accent:#d6a84f;--accent-soft:rgba(214,168,79,.16);--shadow:0 22px 60px rgba(0,0,0,.34);--spark:rgba(214,168,79,.18);--texture:repeating-linear-gradient(90deg,rgba(214,168,79,.08) 0 1px,transparent 1px 36px);--texture-size:auto;--texture-opacity:.44}.theme-paper{--card:#fbfff7;--panel:#e8f2df;--border:#bad3b2;--muted:#53624e;--accent:#166534;--accent-soft:#d9f99d;--shadow:0 16px 36px rgba(39,77,32,.1);--spark:rgba(22,101,52,.13);--texture:repeating-linear-gradient(0deg,transparent 0 31px,rgba(22,101,52,.1) 32px),linear-gradient(90deg,rgba(22,101,52,.16) 0 2px,transparent 2px);--texture-size:auto;--texture-opacity:.45}.theme-cobalt{--card:rgba(8,29,66,.9);--panel:rgba(16,50,110,.78);--border:rgba(250,204,21,.3);--muted:#b8c9e6;--accent:#facc15;--accent-soft:rgba(250,204,21,.17);--shadow:0 20px 55px rgba(0,0,0,.32);--spark:rgba(250,204,21,.18);--texture:linear-gradient(90deg,rgba(250,204,21,.12) 1px,transparent 1px),linear-gradient(rgba(56,189,248,.12) 1px,transparent 1px);--texture-size:52px 52px;--texture-opacity:.42}.theme-highlighter{--card:#fff;--panel:#fff7b8;--border:#111827;--muted:#4b5563;--accent:#111827;--accent-soft:#fef08a;--shadow:8px 8px 0 rgba(17,24,39,.12);--spark:rgba(22,163,74,.14);--texture:linear-gradient(transparent 62%,rgba(250,204,21,.28) 62%);--texture-size:100% 34px;--texture-opacity:.38}body:before{content:"";position:fixed;inset:0;z-index:0;pointer-events:none;background-image:var(--texture,none);background-size:var(--texture-size,auto);opacity:var(--texture-opacity,0)}.theme-swiss .card,.theme-swiss .kpi,.theme-swiss .cat-card,.theme-swiss .risk-card,.theme-swiss .metric-card,.theme-highlighter .card,.theme-highlighter .kpi,.theme-highlighter .cat-card,.theme-highlighter .risk-card,.theme-highlighter .metric-card{border-radius:6px}.theme-terminal .hero h1,.theme-blueprint .hero h1,.theme-cobalt .hero h1{text-transform:uppercase}.theme-ink .hero h1,.theme-red .hero h1,.theme-gold .hero h1{font-family:Georgia,"Times New Roman","Songti SC",serif}.theme-highlighter .section-title span,.theme-highlighter .card-title span{border:1px solid #111827}.theme-terminal .data-table td,.theme-terminal .data-table th{font-family:"SFMono-Regular","Menlo","Consolas",monospace}@media(max-width:980px){.hero,.two-col,.funnel-layout{grid-template-columns:1fr}.kpi-grid,.cat-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.risk-grid,.special-grid,.metric-grid{grid-template-columns:1fr}}@media(max-width:640px){.page-shell{width:min(100% - 20px,1180px);padding-top:24px}.kpi-grid,.cat-grid{grid-template-columns:1fr}.hero h1{font-size:36px}.bar-item{grid-template-columns:1fr}.bar-item small{white-space:normal}.meta-panel{grid-template-columns:72px 1fr}.data-table{display:block;overflow-x:auto;white-space:nowrap}}
"""
...
function animateBg(){
  ...
  function step(){ctx.clearRect(0,0,canvas.width,canvas.height);ctx.fillStyle=getComputedStyle(document.body).getPropertyValue("--spark").trim() || "rgba(56,189,248,.18)";for(const p of points){p.x+=p.vx;p.y+=p.vy;if(p.x<0||p.x>canvas.width)p.vx*=-1;if(p.y<0||p.y>canvas.height)p.vy*=-1;ctx.beginPath();ctx.arc(p.x,p.y,p.r,0,Math.PI*2);ctx.fill()}requestAnimationFrame(step)}
