...
SEMANTIC_FIELDS = {
    ...
    "tester": ["测试", "qa"],
    "amount": ["金额", "gmv", "支付金额", "收入", "销售额", "成交金额", "预计金额", "商机金额", "合同金额", "库存金额"],
    "quantity": ["数量", "件数", "销量", "库存", "可用库存", "现存量"],
    "date": ["日期", "时间", "单据日期", "订单日期", "创建时间", "下单时间", "提交时间", "提出时间", "评价时间", "跟进时间"],
    ...
    "sla": ["SLA", "是否超时", "超时", "逾期"],
    "shipment_status": ["出库状态", "发货状态", "交付状态", "行出库状态"],
    "collection_status": ["订单收款状态", "收款状态", "回款状态", "付款状态"],
    "invoice_status": ["开票状态", "行开票状态", "发票状态"],
    "outstanding_amount": ["订单未收款金额", "未收款金额", "未回款金额", "应收余额", "欠款金额"],
}
